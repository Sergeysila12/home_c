...
//~ {
	...
	//~ AddRecord(Info, counter++,  2000, 10, 8, 14, 30, 0);
	//~ AddRecord(Info, counter++,  2001, 4, 16, 8, 0, -3);
	//~ AddRecord(Info, counter++,  2002, 8, 1, 10, 15, 20);
	//~ AddRecord(Info, counter++,  2002, 1, 3, 4, 45, -30);
	//~ AddRecord(Info, counter++,  2003, 3, 8, 18, 10, -1);
	//~ AddRecord(Info, counter++,  2004, 1, 6, 12, 10, -6);
	//~ AddRecord(Info, counter++,  2001, 2, 10, 7, 15, -8);
	//~ AddRecord(Info, counter++,  2004, 5, 11, 9, 18, 2);
	//~ AddRecord(Info, counter++,  2001, 6, 18, 10, 20, 26);
	//~ AddRecord(Info, counter++,  2003, 7, 6, 16, 30, 25);
	//~ AddRecord(Info, counter++,  2000, 11, 15, 10, 10, -2);
	//~ AddRecord(Info, counter++,  2001, 12, 15, 10, 10, -6);
	//~ AddRecord(Info, counter++,  2000, 8, 15, 10, 10, 21);
	//~ AddRecord(Info, counter++,  2002, 9, 21, 10, 10, 14);
	//~ AddRecord(Info, counter++,  2004, 9, 15, 10, 10, 18);
	//~ AddRecord(Info, counter++,  2004, 5, 20, 30, 10, 10);
